...
urlpatterns = [
    ...
    path('training_list/<int:program_id>',
         views.training_list_view, name="training_list"),
    ...
    path('exercise_details/<int:program_id>/<int:exercise_id>',
         views.exercise_details_view, name="exercise_details"),
